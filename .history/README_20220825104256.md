...
It is desired to have a REST API with statistics from the Star Wars universe. We request 3 endpoints:

* Taking into account that a planet can have more than one climate, calculate the average population of inhabitants per climate. **(NOT FINISHED)**
