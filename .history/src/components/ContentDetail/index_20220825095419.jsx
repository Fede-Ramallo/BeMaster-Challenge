  ...
  return (
    <div className="Details">
      ...
      <div className="Details-Text">
        ...
        <motion.h3 initial={{ opacity: 0.75 }} whileInView={{ opacity: 1, transition: { duration: 1, repeat: Infinity} }}>MORE DETAILS UNDER CONSTRUCCION, COME BACK LATER, THERE MIGHT BE SOME UPGRADES!</motion.h3>
