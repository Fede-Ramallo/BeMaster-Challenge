  ...
  return (
    <div className="Details">
      ...
      <div className="Details-Text">
        ...
        <motion.h3 whileInView={{ opacity: [0.75, 1, 0.75], transition: { duration: 3, repeat: Infinity} }}>MORE DETAILS UNDER CONSTRUCCION, COME BACK LATER, THERE MIGHT BE SOME UPGRADES!</motion.h3>
