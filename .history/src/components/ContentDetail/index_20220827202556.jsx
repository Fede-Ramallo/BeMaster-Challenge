    ...
    <div className="details">
      <div className="detailsImage">
        <div className="detailsImageContainer">
          <motion.img src={`${srcimg}${details.poster_path}`} alt="postermovie" whileHover={{ scale: 1.17, transition: { duration: 0.3 } }} />
        </div>
      </div>
      <motion.div className="detailsText" variants={fadeIn} >
        <h2>
