  ...
  return (
    <div className="details">
      <div className="detailsImage">
        ...
        >
          <motion.img
            ...
            initial="hidden"
            animate="visible"
            whileHover={{ scale: 1.17, transition: { duration: 0.3 } }}
          />
        </motion.div>
      </div>
      <motion.div
      ...
      >
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/c-NotsoQyno" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </motion.div>
    </div>
  );
};
