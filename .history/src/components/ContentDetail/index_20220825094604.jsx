  ...
  return (
    <div className="Details">
      ...
      <div className="Details-Text">
        ...
        <motion.h3 whileOnView={{ opacity: 1, transition:{ duration: 1, repeat: Infinity} }}>MORE DETAILS UNDER CONSTRUCCION, COME BACK LATER, THERE MIGHT BE SOME UPGRADES!</motion.h3>
