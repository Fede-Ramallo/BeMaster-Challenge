  ...
  return (
    <div className="Details">
      ...
      <div className="Details-Text">
        ...
        <motion.h3 initial={{ opacity: 0 }} whileInView={{ opacity: 1, transition: { duration: 1, } }}>MORE DETAILS UNDER CONSTRUCCION, COME BACK LATER, THERE MIGHT BE SOME UPGRADES!</motion.h3>
