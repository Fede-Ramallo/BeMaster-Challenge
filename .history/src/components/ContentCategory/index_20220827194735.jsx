...
const ContentCategory = () => {
  ...
  const fetchURL = `/discover/movie?api_key=${API_KEY}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${index + 1}&with_genres=${category.id}&with_watch_monetization_types=flatrate`;
  ...
  return (
    <div className="category">
      ...
      <button onClick={handleSubtraction}>Go Back</button>
